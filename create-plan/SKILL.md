---
name: create-plan
description: "Interviews the user until a goal is fully planned and ready for a specification. If the goal is too large for one session, creates a roadmap: a DAG of grill, research, prototype, and task sessions. /advance-plan then works the roadmap, one node for each session."
